...
const randomMessages = [
	...
	'MadMarks: "Я не токсик, я просто лучше вас всех играю"',
	'Пост MadMarks с AWP-вонтапом набрал 150к лайков за 4 часа',
	'GhostKiller ушёл в VALORANT после провала на мейджоре',
	'Alt стал тренером академии Mad Dogs',
	'Nemesis использовали фейковый состав на квалификациях — скандал дня',
	'ZywOo удалил Twitter после слива от MadMarks в прямом эфире',
	'Wolf заявил: "Мы не читеры, мы просто умнее"',
	'Скандал: подозрение на автоаим у SilentKiller в четвертьфинале',
	'MadMarks отказался от контракта с NightWolves ради свободы',
	'Документалка "Жизнь в прицеле: история MadMarks" выйдет на стриминге в сентябре',
	'Петиция фанатов за возвращение Stinger собрала 40 тысяч подписей',
	'В интервью для HLTV MadMarks сказал: "GG — это не игра. Это я"',
	'Турнир в Кёльне: Mad Dogs снова в полуфинале',
	'Читерская сеть Infernity была раскрыта — задержаны два аналитика',
	'MadMarks проиграл пистолетку и пошёл готовить пельмени на стриме',
	'Организация отказалась от MadMarks после твита про "мышку наебнулась"',
	'Новая мета: флешки под спавн и rush через дым стали нормой',
	'Хайлайт дня: эйс от Alt на карте Mirage за 24 секунды',
	'Психолог команды Heroic: "MadMarks непредсказуем. Это его сила и слабость"',
	'MadMarks: "Если я в форме — у них нет шанса. Если не в форме — у них всё равно нет шанса"',
	'Тренер Wolf подал в отставку. Новым наставником стал игрок по кличке "Курьер"'
];
